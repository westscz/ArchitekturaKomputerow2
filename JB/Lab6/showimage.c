...
void gFilter(unsigned char * buf, int width,int height,int size,char bpp, int RowSize)
{
int i, j, k;
char temp;
	for(i=0; i < height ; i++)
...
void iFilter(unsigned char * buf, int width,int height,int size,char bpp, int RowSize)
{
int it, j, k;
double r, g, b, y, i ,q;
char temp;
...
void vFilter(unsigned char * buf, int width,int height,int size,char bpp, int RowSize)
{
int i, j, k;
char temp;
...
void hFilter(unsigned char * buf, int width,int height,int size,char bpp, int RowSize)
{
int i, j, k;
char temp;
	for(i=0; i < height; i++)
		...
		if ( SDL_PollEvent(&event) ) {
			switch (event.type) {
				...
				switch (event.key.keysym.sym) {
					...
					gFilter(image->pixels,image->w,image->h, size, image->format->BytesPerPixel, RowSize );
					printf("Done.\n");
					...
					printf("Start filtering...  ");
					vFilter(image->pixels,image->w,image->h, size, image->format->BytesPerPixel, RowSize );
					printf("Done.\n");
					...
					printf("Start filtering...  ");
					iFilter(image->pixels,image->w,image->h, size, image->format->BytesPerPixel, RowSize );
					printf("Done.\n");
					...
					printf("Start filtering...  ");
					hFilter(image->pixels,image->w,image->h, size, image->format->BytesPerPixel, RowSize );
					printf("Done.\n");
